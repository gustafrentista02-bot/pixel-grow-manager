...
export function exportLeadsCsv(leads: Lead[]) {
  const rows = leads.map((l) => ({
    ...
    valor_proposta: l.valor_proposta ?? 0,
    ...
    ultimo_contato: formatDateTime(l.last_interaction_at),
    proximo_followup: l.proximo_followup_at ? formatDateTime(l.proximo_followup_at) : "",
